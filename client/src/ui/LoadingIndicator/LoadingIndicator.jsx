  ...
  <svg height="108px" width="108px" viewBox="0 0 128 128" className={styles.loader}>
    <defs>
      <clipPath id="loader-eyes">
        <circle transform="rotate(-40,64,64) translate(0,-56)" r="8" cy="64" cx="64" className={styles["loader__eye1"]}></circle>
        <circle transform="rotate(40,64,64) translate(0,-56)" r="8" cy="64" cx="64" className={styles["loader__eye2"]}></circle>
      </clipPath>
    ...
    <g strokeDasharray="175.93 351.86" strokeWidth="12" strokeLinecap="round">
      <g>
        ...
        <g stroke="hsl(193,90%,50%)" fill="none">
          <circle transform="rotate(180,64,64)" r="56" cy="64" cx="64" className={styles["loader__mouth1"]}></circle>
          <circle transform="rotate(0,64,64)" r="56" cy="64" cx="64" className={styles["loader__mouth2"]}></circle>
        </g>
      </g>
